...
public class AttendanceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragView =  inflater.inflate(R.layout.attendance_fragment, container, false);
        courseList = (ListView) fragView.findViewById(R.id.lv_attendance);
        String[] from = {"CNAME","TOT_CLASSES"};
        int[] to = {R.id.tv_cname,R.id.tv_tot_classes};
        cursor = dbhelper_obj.getAllData("Courses");
        SimpleCursorAdapter curAdapter = new SimpleCursorAdapter(getActivity(),R.layout.attendance_item_row,cursor,from,to);
